/* ============================================================
   Geo (City) Content, 8 Phase 1 cities
   Used by GeoPageB template (service-first hero).
   ============================================================ */
...
const GEO_CONTENT = {
  ...
  "kissimmee": {
    ...
    differentiators: [
      ...
      { title: "Townhome Practice Depth", body: "Building-envelope coordination, master-policy tracking, party-wall protocols." },
      { title: "Rental-Adjacent Community Awareness", body: "Communities near the attractions corridor have unique enforcement and tenancy considerations." },
      { title: "Dedicated Back-Office Departments", body: "Enforcement, accounting, collections, specialists in each." },
      { title: "Local Vendor Network", body: "Edison's Osceola County vendor relationships span landscape, pool, paving, and roofing." },
  ...
  "lake-mary": {
    ...
    differentiators: [
      ...
      { title: "Industry-Low Manager Turnover", body: "Lake Mary boards know what manager churn costs. Edison's structure removes the risk." },
  ...
  "altamonte-springs": {
    ...
    differentiators: [
      ...
      { title: "Reserve Study Coordination", body: "Engineer sourcing, scope review, and funding plan integration on a documented cadence." },
      { title: "Older-Community Vendor Network", body: "Vendor relationships span the trades older communities actually need, roofing, paint, plumbing repair." },
      { title: "Industry-Low Manager Turnover", body: "The Edison manager who knows your community's capital history stays." },
      { title: "Modern Stack, Older Communities", body: "CINC dashboards work for boards who want them and email coverage for boards who don't." },
  ...
  "brevard-county": {
    ...
    differentiators: [
      ...
      { title: "Engineer Coordination", body: "Working relationships with FL-licensed structural engineers across the coast." },
      { title: "Hurricane-Aware Operations", body: "Storm prep, insurance claims, post-event capital coordination, built into the workflow." },
      { title: "Master Insurance Tracking", body: "Coastal master policies require specialized handling. Edison knows the carriers and the cadence." },
      { title: "Reserve Discipline for Aging Buildings", body: "Most Brevard coastline condos are 30+ years old. Reserve work is the work." },
