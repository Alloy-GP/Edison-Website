...
const BLOG_CONTENT = {
  ...
  "hoa-audit": {
    ...
    related: [
      { category: "Financial Management", title: "How to Prepare an HOA Budget: A Board's Step-by-Step Guide", image: "/assets/blog/hoa-budget-preparation.webp", href: "/blog/hoa-budget-preparation" },
  ...
  "hoa-budget-preparation": {
    ...
    // Shorter than the H1 so the SERP result doesn't truncate, and geo-qualified.
    titleTag: "How to Prepare an HOA Budget (Florida Board Guide) | Edison",
    ...
    readTime: "8 min",
    keywords: ["how to prepare an hoa budget", "hoa budget", "hoa budget preparation", "hoa annual budget", "florida hoa budget requirements", "hoa reserve funding"],
    about: ["HOA budget", "Reserve funding", "Florida homeowners association", "Community association governance"],
    heroImage: "/assets/blog/hoa-budget-preparation.webp",
    // Social platforms handle JPEG more reliably than WebP — used for og:image only.
    ogImage: "/assets/blog/hoa-budget-preparation.jpg",
    ...
    keyTakeaways: [
      "An HOA budget has two parts: the <strong>operating budget</strong> (day-to-day recurring costs) and <strong>reserve funding</strong> (saving toward major component replacement).",
      "Set the adoption meeting date first and plan <strong>backwards</strong> from it. Planning forward is how boards run out of runway.",
      "Build from last year's <strong>actuals</strong>, not last year's projections, and re-bid expiring vendor contracts before projecting a single expense.",
      "Fund reserves from the <strong>reserve study</strong>, not a guess. Dues follow the budget, not the other way around.",
      "In Florida, the <strong>board adopts</strong> the budget at a properly noticed meeting; owners generally do not vote, but they must receive the proposed budget in advance."
    ],
    intro: [
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Reserve funding is different. It sets aside money for the major components that will reach the end of their useful life someday: the roofs, roads, pools, and painting that represent large capital expenses down the road. Rather than hitting owners with a surprise <a href=\"/blog/hoa-special-assessment\">special assessment</a> when a roof needs replacing, the association sets money aside each year through steady reserve contributions. A healthy HOA budget treats both parts as non-negotiable rather than trimming reserves to keep dues flat."
        ],
        table: {
