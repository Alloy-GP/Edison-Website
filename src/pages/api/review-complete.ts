  ...
  try {
        ...
        await fetch(slackWebhook, {
          ...
          body: JSON.stringify({
            blocks: [
              {
                type: 'header',
                text: { type: 'plain_text', text: '✅ Edison preview review submitted', emoji: true },
              },
              {
                type: 'section',
                fields: [
              ...
              { type: 'divider' },
              {
                ...
                elements: [{
                  type: 'mrkdwn',
                  text: `Edison staging site · <https://stg-edison.vercel.app|View site>`,
                }],
              },
            ],
          }),
    ...
    try { if (!resend) throw new Error('no key');
      await resend.emails.send({
        from: 'Edison Preview <noreply@alloygp.co>',
        to: 'team@alloygp.co',
        subject: `[Edison] Preview review submitted by ${reviewer}`,
        html: `
